  ...
  return (
    <div className="h-full w-full flex flex-col bg-gray-50">
      ...
      <div className="flex items-center justify-between px-6 py-4 bg-white border-b border-gray-200">
        <div>
          <h1 className="text-2xl font-semibold text-gray-900">Model Routings</h1>
      ...
      <div className="flex items-center gap-4 px-6 py-4 bg-white border-b border-gray-200">
        ...
        <div className="w-64">
          <select
            ...
            className="w-full px-4 py-2 border border-gray-300 rounded-md text-gray-900 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none"
          >
      ...
      <div className="flex-1 overflow-auto">
        {isLoading ? (
          <div className="flex items-center justify-center h-64">
            <div className="text-gray-500">Loading routings...</div>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <thead className="bg-gray-50 border-b border-gray-200">
                  <tr>
                    <th className="py-3 px-4 text-left text-xs uppercase text-gray-500 font-semibold w-64">
                      Model
                    </th>
                    <th className="py-3 px-4 text-left text-xs uppercase text-gray-500 font-semibold w-48">
                      Family
                    </th>
                    <th className="py-3 px-4 text-left text-xs uppercase text-gray-500 font-semibold">
                      Routing
                    </th>
                    <th className="py-3 px-4 text-right text-xs uppercase text-gray-500 font-semibold w-32">
                      Actions
                    </th>
                  </tr>
                </thead>
